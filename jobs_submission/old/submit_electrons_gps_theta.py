...
macFilePath = "/ilc/user/e/eleogran/mac/electrons/"+macFile
nameTag = 'electrons_'+gunTheta+'deg'
...
baseSteeringMarlin = 'loca/path/CLICPerformance/clicConfig/steeringFiles/clicReconstruction.xml'
nameSteeringMarlin = "local/path/CLICPerformance/clicConfig/clicReconstruction_final.xml"
templateOutRoot = "histograms"
rootFile = 'electrons_'+gunTheta+'deg'
outputFile = 'electrons_'+gunTheta+'deg.slcio'
