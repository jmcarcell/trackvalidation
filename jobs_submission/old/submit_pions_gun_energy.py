...
rootFile = 'pions_'+gunEnergy+'GeV'
outputFile = 'pions_'+gunEnergy+'GeV.slcio'
...
ddsim.setExtraCLIArguments(" --enableGun --gun.particle pi- --gun.energy %(energy)s*GeV --gun.distribution uniform" % {'energy' : gunEnergy})
