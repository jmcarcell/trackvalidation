...
nameTag = 'electrons_'+gunEnergy+'GeV'
...
rootFile = 'electrons_'+gunEnergy+'GeV'
outputFile = 'electrons_'+gunEnergy+'GeV.slcio'
...
ddsim.setExtraCLIArguments(" --enableGun --gun.particle e- --gun.energy %(energy)s*GeV --gun.distribution uniform" % {'energy' : gunEnergy})
